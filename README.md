...
- **MONAI**: Medical Open Network for AI (framework for medical imaging DL)
- **SegResNet (MONAI)**: 3D segmentation backbone used here
- **YOLOv8**: Ultralytics detection model family
- **EDT**: distance transform for radius/diameter estimation
- **Skeletonization**: extracting a thin medial representation of a 3D binary object

> Add your paper and any prior work you want to cite in the next section.
...
1) This repository:
- `slikyumsh/Stenosis3D`

2) Our accompanying manuscript (fill in final bibliographic info):
- *[Authors]*. *[Title]*. *[Venue / Preprint]*, *[Year]*. *[URL/DOI/arXiv]*.

BibTeX template:

```bibtex
@misc{stenosis3d2026,
  title   = {Stenosis3D: 3D Vessel Segmentation and Stenosis Analysis via Centerline Geometry and 2D Projections},
  author  = {<YOUR NAMES HERE>},
  year    = {2026},
  note    = {GitHub repository: https://github.com/slikyumsh/Stenosis3D},
  url     = {https://github.com/slikyumsh/Stenosis3D}
}
```
